  ...
  return `
    <div class="slide slide-content ${layoutClass} slide--question${extraClass}">
      <div class="question-container">
        ${stage}${coachingTag}<h2 class="question-text fade-in" style="animation-delay:0.05s">${escHtml(cleanText(String(slide.question || "")))}</h2>
        <div class="slideSubtext slidePassage fade-in" style="animation-delay:0.15s">${escHtml(cleanText(String(slide.prompt || "")))}</div>
        ${choices}
    ...
    container.innerHTML = `
      <div class="slide slide-content slide--question${extraClass}">
        <div class="question-container">
          ...
          <div class="slideSubtext slidePassage">${escHtml(slide.prompt)}</div>
          ${choices}
          ${rationale}
          ${coachLine}${alignment}
        </div>
